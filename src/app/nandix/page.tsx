                            ...
                            <div className={`relative max-w-[90%] md:max-w-[85%] px-5 md:px-7 py-3 md:py-4 transition-all duration-500 ${isMe
                                ...
                                <div className="flex items-center justify-between gap-4 mb-2">
                                    <div className="flex items-center gap-2">
                                        <div className="w-4 h-4 rounded-[0.4rem] bg-white/[0.03] border border-white/[0.05] flex items-center justify-center">
                                            <User className="w-2 h-2 text-zinc-500" />
                                        </div>
                                ...
                                {msg.mediaType === "voice" && msg.mediaData && (
                                    <div className="mb-4 px-4 py-3 rounded-xl bg-white/[0.02] border border-white/[0.05] flex items-center gap-4">
                                        <div className="w-8 h-8 rounded-full bg-emerald-500/10 flex items-center justify-center shrink-0">
                                            <Play className="w-3 h-3 text-emerald-400" />
                                        </div>
                                        <div className="flex-1 h-1.5 bg-white/[0.05] rounded-full relative overflow-hidden">
                                            <div className="absolute inset-y-0 left-0 w-1/3 bg-emerald-500/30" />
                                        </div>
                                        <audio src={msg.mediaData} controls className="hidden" />
                                        <span className="text-[10px] font-mono text-zinc-600">VOICE</span>
                                    </div>
                                )}
                        ...
                        {!isRecording ? (
                            <>
                                <button
                                    ...
                                    className="w-10 h-10 rounded-2xl bg-white/[0.03] border border-white/5 flex items-center justify-center shrink-0 hover:border-emerald-500/30 transition-all"
                                >
                                ...
                                <input
                                    ...
                                    className="flex-1 bg-transparent text-[14px] text-zinc-200 placeholder-zinc-700 outline-none font-medium tracking-tight"
                                />
            ...
            <div className="w-full grid grid-cols-3 gap-3 pt-6 pb-4">
                {[
                    ...
                    const colorClasses: Record<string, string> = {
                        cyan: "text-cyan-500/60 group-hover:text-cyan-400",
                        emerald: "text-emerald-500/60 group-hover:text-emerald-400",
                        violet: "text-violet-500/60 group-hover:text-violet-400",
                    };
                    return (
                        <motion.div
                            key={stat.label}
                        ...
                        >
                            <div className={`${colorClasses[stat.color as keyof typeof colorClasses]} mb-2 transition-colors`}>
                                {stat.icon}
                            </div>
